            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" src="{{asset('storage/' . $user->image->path)}}" alt="User profile picture">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Role</b> <a class="pull-right">{{$user->role->name}}</a>

                        </ul>

                        {{--<a href="{{ route('admin.users.edit', ['id' => $user -> id]) }}" class="btn btn-primary btn-block"><b>Edit User id: {{$user->id}}</b></a>--}}
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="settings">
                            <form class="form-horizontal" action="{{route('admin.users.update', ['id' => $user ->id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Role ID</label>

                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="role_id" id="inputName" value="{{$user->role->id}}">
                                    </div>
                                </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {{--{{asset('filesystems.disks.public.url' . '/' . $user->image->path)}}--}}
